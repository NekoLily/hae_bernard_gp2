...
static Vector2f RectPos = Vector2f(50, 50);
...
int main()
{
	...
	{
		printf("Impossible de charger les shders");
	}*/
	...
	while (window.isOpen())
	{
		...
		//DrawCircle(window);
		//DrawCurve(window, FrameStart.asSeconds());
		//drawCatmull(window, FrameStart.asSeconds());
		DrawSquare(window, FrameStart.asSeconds());
		window.draw(text);
		window.display();
